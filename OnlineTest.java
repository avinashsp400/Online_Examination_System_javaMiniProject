...
//System.out.println("correct ans="+count);
    ...
    void set() {
        ...
        if(current==1)
        {
            label.setText("Que2: Which Feature of Java 7 allow to not explicitly clode IO resource?");
        ...
        if(current==2)
        {
            ...
            radioButton[2].setText("can't say");
        ...
        if(current==4)
        {
            label.setText("Que5: Which is the container that doesn't contain title bar and MenuBar but it can have other components like button, textfield etc");
                    radioButton[0].setText("Window");
            radioButton[1].setText("Frame");
            radioButton[2].setText("Panel");
            radioButton[3].setText("container");
        }
        if(current==5)
        {
        ...
        if(current==6)
        {
            label.setText("Que7: AWT Stands for");
            radioButton[0].setText("Abstract Window Toolkit");
            radioButton[1].setText("Anonymus Window Toolkit");
            radioButton[2].setText("Abstract Warning Toolkit");
            radioButton[3].setText("Auto Window Toolkit");
        }
        if(current==7)
        {
            label.setText("Que8: Which is not core interface of Hibernate");
        ...
        if(current==8)
        {
            ...
            radioButton[3].setText("can not say");
        }
        if(current==9)
        {
            label.setText("Que10: How many Layout managers are defined in java.awt package");
